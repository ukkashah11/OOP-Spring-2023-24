...
int main(){
  ...
  ptr->hello(); //base class func is called since hello in base class is not overridden (virtual keyword not used)
  ptr->display(); /*derived class func is called since display in base class has been overridden (virtual keyword used).
